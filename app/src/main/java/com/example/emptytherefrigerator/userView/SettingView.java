...
public class SettingView extends AppCompatActivity
{
    ...
    public void setListener()
    {
        btnDelete.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext()); //aert 창
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener()   //ok 클릭시 회원정보 삭제
                {
